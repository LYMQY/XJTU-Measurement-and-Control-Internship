...
void main(void)
{
	...
	while (1)
	{
		...
		if (DI[7] == 0 && DI[0] == 1 && run == 0 && floor == 1 && doorclose == 1)
		{
			run = 1;
			_outp(BASE_ADDRESS + iPort, 9);
			Sleep(1000);
		...
		if (DI[0] == 0 && DI[7] == 1 && run == 0 && floor == 1 && doorclose == 1)
		{
			_outp(BASE_ADDRESS + iPort, 5);
			Sleep(1000);
			doorclose = 0;
		...
		if (DI[0] == 0 && DI[7] == 1 && run == 0 && floor == 2 && doorclose == 1)
		{
			_outp(BASE_ADDRESS + iPort, 10);
			Sleep(1000);
		...
		if (DI[7] == 0 && DI[0] != 0 && run == 0 && floor == 2 && doorclose == 1)
		{
